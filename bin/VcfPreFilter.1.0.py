...
def __main__():
	...
	"\n\nThis script filter VCF file generated by Process_RNAseq.py or process_reseq.py by"
	"\nremoving homozygous sites for all accessions based on parameters passed.")
	# Wrapper options.
