...
This section aimed at studying the ancestral contribution along chromosomes
...
*data/config/Origin.tab* is a file which contained path to vcf files which
...
Goes to the TestTools folder and run the following command line:
```
