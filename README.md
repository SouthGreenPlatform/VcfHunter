...
*Outputs:*<br/>
**_centroid_coordinates.tab:** Coordinates of the distincts final centroides carculated for the X k-mean random starpoints.<br/>
...
**_kMean_gp_prop.tab:** A tabulated file reporting for each allele the number of time it has been attributed to the same cluster among the X random startpoint.<br/>
<br/>
...
*Output:* <br/>
**Accession.pdf:** A pdf file with chromosome painting for all chromosomes of this accession.
